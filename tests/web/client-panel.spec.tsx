...
const catalog: BridgeCatalogResult = {
  providers: [{
    ...
    installed: true,
    version: '0.155.1',
    supportedRange: '>=0.147.0 <0.156.0',
    permissionModes: [],
...
describe('LocalAgentPanel', () => {
  ...
  it('explains an unusable product instead of silently omitting it', async () => {
    ...
    expect(screen.getByText(/Codex 0\.144\.6 installed; this bridge admits >=0\.147\.0 <0\.156\.0/)).toBeTruthy()
  ...
  it('opens a session with the facts a first prompt depends on', async () => {
    ...
    expect(opening.getByText('Codex 0.155.1')).toBeTruthy()
