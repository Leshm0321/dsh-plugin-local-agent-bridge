...
| 17 | Unsupported versions are blocked explicitly | Automated | Version parsing and admission tests enforce Codex `0.147.x` and Claude Code `>=2.1.220 <2.2.0`; unverified versions require explicit `allowExperimentalVersions`. |
