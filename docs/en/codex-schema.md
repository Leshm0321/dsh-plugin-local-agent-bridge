...
The JSON Schema files under `generated/codex/0.153.4/schema/` were generated from the Host-installed Codex CLI `0.153.4` with the experimental App Server generators:
