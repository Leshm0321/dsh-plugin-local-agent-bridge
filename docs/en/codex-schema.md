...
The JSON Schema files under `generated/codex/0.155.1/schema/` were generated from the Host-installed Codex CLI `0.155.1` with the experimental App Server generators:

```sh
codex app-server generate-ts --experimental --out generated/codex/0.155.1/ts
codex app-server generate-json-schema --experimental --out generated/codex/0.155.1/schema
```
